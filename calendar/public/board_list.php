            ...
            <table class="table table-hover text-center">
                <thead class="table-primary">
                    <tr>
                        ...
                        <th scope="col1" width="400" class="text-left">제목</th>
                ...
                <tbody>
                    <tr>
                        <th scope="row" width="70"><?php echo $num; ?></th>
                            ...
                            <?php
                                if($board['password']=="" || $board['password']==null) {    //비번 없는 글
                                    echo "<a href='board_read.php?id=".$board['id']."'>".$title."</td><td width='120'>";
                                    echo $board['name'];
                                } else {    //비번 있는 글
                                    echo "<a href='board_pwchk.php?id=".$board['id']."'>비밀글입니다. ".$lockimg."</td><td width='120'>";
                                    echo $board['name'];
                                    echo $lockimg;
                                }
                            ?>
                ...
                <button
                    ...
                    onclick="location.href='board_write.php'">글쓰기</button>
